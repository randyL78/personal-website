...
gem 'rails', '~> 6.1.4'
# Use Percona (a mySql clone) as the database for Active Record
gem 'mysql2', '~> 0.5.3'
...
# Convert default log output into more traditional single line output
gem 'lograge'
...
group :development, :test do
  ...
  # Store environment variables for dev and test environments
